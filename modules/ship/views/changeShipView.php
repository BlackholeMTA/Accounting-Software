                                        ...
                                        <div class="col-md-5">
                                            <form method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="volume" type="number" min="0" name="volume" value="<?php if (!empty($_COOKIE['is_login']) || !empty($_SESSION['user_login'])) echo $ship['volume']; ?>" class="form-control" placeholder="Nhập trọng tải toàn phần của tàu">
